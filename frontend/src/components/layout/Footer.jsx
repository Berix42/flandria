...
const FooterLink = ({ to, children, external }) => {
  const className = 'text-sm font-semibold text-center text-slate-500 hover:text-slate-900 dark:text-white dark:hover:text-dark-primary md:text-left';
  ...
  >
    <div className="grid items-center grid-cols-1 gap-4 md:gap-x-12 md:grid-cols-2 justify-items-center">
      <div className="max-w-sm">
        ...
        <p className="text-sm leading-tight text-center text-slate-500 md:text-left dark:text-white">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 md:gap-x-12">
        <div className="flex flex-col">
          <h5 className="mb-1 text-sm font-bold tracking-wide text-center text-slate-700 uppercase dark:text-white md:text-left">Flandria</h5>
          <FooterLink to="/about">About Us</FooterLink>
          <FooterLink to="https://www.github.com/lauderandtaiga/flandria" external>Github</FooterLink>
        </div>

        <div className="flex flex-col">
          <h5 className="mb-1 text-sm font-bold tracking-wide text-center text-slate-700 uppercase dark:text-white md:text-left">Discord</h5>
          <FooterLink to="https://discord.gg/giikugames" external>Florensia</FooterLink>
        </div>

        <div className="flex flex-col">
          <h5 className="mb-1 text-sm font-bold tracking-wide text-center text-slate-700 uppercase dark:text-white md:text-left">Legal</h5>
